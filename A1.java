 ...
 *                                                            *
 * File:       A1			                                  *
 * Changes:    Set animation lower limit to 1	 			  *
 * Comp,Run:   javac *.java;java A1				              *
/*============================================================*/
...
public class A1 extends JFrame {
	...
	public A1() {
		...
		* @return toolsPanel		the Panel
		...
		JSlider slider = new JSlider(JSlider.HORIZONTAL, 1, 100, 100);
		...
		ImageIcon recangletButtonIcon = createImageIcon("pics/rectangle.gif");
		ImageIcon squareButtonIcon = createImageIcon("pics/square.gif");
		ImageIcon ellipseButtonIcon = createImageIcon("pics/ellipse.gif");
		ImageIcon circleButtonIcon = createImageIcon("pics/circle.gif");
		ImageIcon quadcirclesButtonIcon = createImageIcon("pics/quadcircles.gif");
		ImageIcon pixelArtButtonIcon = createImageIcon("pics/pixelArt.gif");
		ImageIcon tuxIcon = createImageIcon("pics/tux2.png");
		ImageIcon neonIcon = createImageIcon("pics/neon2.png");
		ImageIcon windowsIcon = createImageIcon("pics/win2.gif");
		shapesComboBox = new JComboBox<ImageIcon>(new ImageIcon[] {recangletButtonIcon,squareButtonIcon,ellipseButtonIcon,circleButtonIcon,quadcirclesButtonIcon,pixelArtButtonIcon,tuxIcon,neonIcon,windowsIcon } );
		...
		*/
		ImageIcon fallButtonIcon = createImageIcon("pics/fall.gif");
		ImageIcon bounceButtonIcon = createImageIcon("pics/bounce.gif");
		ImageIcon testingButtonIcon = createImageIcon("pics/testing.gif");
